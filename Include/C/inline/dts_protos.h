...
ULONG __DTS_GetRegAddress(__reg("a6") struct Library *, __reg("a0") APTR node, __reg("d1") ULONG instance)="\tjsr\t-66(a6)";
#define DTS_GetRegAddress(node, instance) __DTS_GetRegAddress(DtsParserBase, (node), (instance))

ULONG __DTS_GetRegSize(__reg("a6") struct Library *, __reg("a0") APTR node, __reg("d1") ULONG instance)="\tjsr\t-72(a6)";
#define DTS_GetRegSize(node, instance) __DTS_GetRegSize(DtsParserBase, (node), (instance))

APTR __DTS_GetFirstChildNode(__reg("a6") struct Library *, __reg("a0") char * path, __reg("a1") char * compatible)="\tjsr\t-78(a6)";
#define DTS_GetFirstChildNode(path, compatible) __DTS_GetFirstChildNode(DtsParserBase, (path), (compatible))

APTR __DTS_GetNextSiblingNode(__reg("a6") struct Library *, __reg("a0") APTR node, __reg("a1") char * compatible)="\tjsr\t-84(a6)";
#define DTS_GetNextSiblingNode(node, compatible) __DTS_GetNextSiblingNode(DtsParserBase, (node), (compatible))

APTR __DTS_GetNodeByAlias(__reg("a6") struct Library *, __reg("a0") char * aliasName)="\tjsr\t-90(a6)";
#define DTS_GetNodeByAlias(aliasName) __DTS_GetNodeByAlias(DtsParserBase, (aliasName))

APTR __DTS_GetNodeByChosen(__reg("a6") struct Library *, __reg("a0") char * aliasName)="\tjsr\t-96(a6)";
#define DTS_GetNodeByChosen(aliasName) __DTS_GetNodeByChosen(DtsParserBase, (aliasName))

APTR __DTS_GetNodeByLabel(__reg("a6") struct Library *, __reg("a0") char * labelName)="\tjsr\t-102(a6)";
#define DTS_GetNodeByLabel(labelName) __DTS_GetNodeByLabel(DtsParserBase, (labelName))

APTR __DTS_GetNodeByPath(__reg("a6") struct Library *, __reg("a0") char * path)="\tjsr\t-108(a6)";
#define DTS_GetNodeByPath(path) __DTS_GetNodeByPath(DtsParserBase, (path))

APTR __DTS_GetCompatibleNodeInstance(__reg("a6") struct Library *, __reg("a0") char * compatibleStr, __reg("d1") ULONG instance)="\tjsr\t-114(a6)";
...
APTR __DTS_GetCompatibleNodeOKAY(__reg("a6") struct Library *, __reg("a0") char * compatibleStr)="\tjsr\t-120(a6)";
#define DTS_GetCompatibleNodeOKAY(compatibleStr) __DTS_GetCompatibleNodeOKAY(DtsParserBase, (compatibleStr))

char* __DTS_GetPropertyName(__reg("a6") struct Library *, __reg("a0") APTR property)="\tjsr\t-126(a6)";
#define DTS_GetPropertyName(property) __DTS_GetPropertyName(DtsParserBase, (property))

char* __DTS_GetPropertyStringValue(__reg("a6") struct Library *, __reg("a0") APTR property)="\tjsr\t-132(a6)";
#define DTS_GetPropertyStringValue(property) __DTS_GetPropertyStringValue(DtsParserBase, (property))

APTR __DTS_GetFirstPropertyValue(__reg("a6") struct Library *, __reg("a0") APTR property)="\tjsr\t-138(a6)";
#define DTS_GetFirstPropertyValue(property) __DTS_GetFirstPropertyValue(DtsParserBase, (property))

APTR __DTS_GetNextPropertyValue(__reg("a6") struct Library *, __reg("a0") APTR value)="\tjsr\t-144(a6)";
#define DTS_GetNextPropertyValue(value) __DTS_GetNextPropertyValue(DtsParserBase, (value))

ULONG __DTS_GetValueSize(__reg("a6") struct Library *, __reg("a0") APTR value)="\tjsr\t-150(a6)";
#define DTS_GetValueSize(value) __DTS_GetValueSize(DtsParserBase, (value))

UWORD __DTS_GetValueType(__reg("a6") struct Library *, __reg("a0") APTR value)="\tjsr\t-156(a6)";
#define DTS_GetValueType(value) __DTS_GetValueType(DtsParserBase, (value))

APTR __DTS_GetValue(__reg("a6") struct Library *, __reg("a0") APTR value)="\tjsr\t-162(a6)";
